...
class EmptyViewComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.title = Text(page, f'{identifier}-empty-view-title-text', 'empty-view-title-text')
        self.description = Text(page, f'{identifier}-empty-view-description-text', 'empty-view-description-text')
