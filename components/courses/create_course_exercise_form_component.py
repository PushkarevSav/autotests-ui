...
class CreateCourseExerciseFormComponent(BaseComponent):
    ...
    def __init__(self, page: Page):
        ...
        self.title_input = Input(page, "create-course-exercise-form-title-{index}-input", 'Input')
        self.description_input = Input(page, "create-course-exercise-form-description-{index}-input", 'Description input')
